...
import com.backend.RESTAPI.model.UserModel;
import com.backend.RESTAPI.repository.UserRespository;
...
public class UserController {
    ...
    UserModel userById(@PathVariable Long id) {
        return userRespository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
